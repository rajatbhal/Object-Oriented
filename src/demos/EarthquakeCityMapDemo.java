...
//		map = new UnfoldingMap(this, 200, 50, 700, 500, new OpenStreetMap.OpenStreetMapProvider() );
	    ...
	    map.zoomToLevel(1);
	    //makes map come to life provided by MapUtils library
	    ...
	    Location valLoc = new Location(29.6f,79.9f);
	    //Marker val = new SimplePointMarker(valLoc);
	    PointFeature karnal = new PointFeature(valLoc);
	    karnal.addProperty("state", "haryana");
	    map.addMarker(createMarker(karnal));
...
//	    
	...
	public void draw() {
	    //background(10);
	    //draw() method will work continuously and will 
	    map.draw();
	    addKey();
	    addbutton();
	...
	public void mouseReleased() {
		...
		if(mouseX > 300 && mouseX < 325 && mouseY >100 && mouseY < 125) {
			background(255, 255, 255);
		}else if(mouseX > 300 &&  mouseX < 325 && mouseY > 150 && mouseY < 175) {
			background(255, 0, 0);
		}
	}
